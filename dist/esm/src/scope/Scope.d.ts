 ...
 * E.g. for a singleton injectable for which only a single instance should exist at all times, {@link DefaultScopes#SINGLETON} is used.
 *
 ...
 * If null is returned ({@link DefaultScopes#PROTOTYPE}), a new instance will be created for every request,
