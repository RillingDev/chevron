 ...
 * @public
 */
declare type Factory<TInstance, UInitializer, VDependency, WContext> = (initializer: UInitializer, dependencies: VDependency[], context: WContext, injectableEntryName: string) => TInstance;
export { Factory };
