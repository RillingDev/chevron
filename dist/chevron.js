...
const Chevron = class {
  ...
  constructor() {
    //Instance container
    this.$ = new Map(); // Adds default types
  ...
  set(moduleName, dependencies, content, constructorFunction) {
    ...
    _module.push(() => {
      const constructedDependencies = dependencies.map(dependencyName => this.get(dependencyName)); //Calls constructorFunction on the module
